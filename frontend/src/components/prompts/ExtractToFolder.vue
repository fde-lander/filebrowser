  ...
  <div class="card-content">
    ...
    <div v-show="!isLoading">
      ...
      <template v-else>
        ...
        <p class="prompts-label">{{ $t("prompts.extractToFolderDestination") }}</p>
        <div
          aria-label="extract-to-folder-destination"
...
export default {
  ...
  mounted() {
    const folderName = this.defaultFolderName;
    this.destPath = this.parentPath + folderName + "/";
  ...
  methods: {
    ...
    createNewDir() {
      ...
      this.newDirName = this.defaultFolderName;
      this.$nextTick(() => {
    ...
    async submit() {
      ...
      try {
        ...
        const parentDest = this.parentPath;
        ...
        notify.showSuccess(this.$t("prompts.extractToFolderSuccess"), {
          icon: "folder",
